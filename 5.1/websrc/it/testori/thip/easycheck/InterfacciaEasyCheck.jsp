     ...
     <td height="100%"><div class="tabbed_pagine" id="tabbedPagine" style="position: relative; width: 100%; height: 100%;">
              <div class="tabbed_page" id="<%=mytabbed.getTabPageId("tab1")%>" style="width:100%;height:100%;overflow:auto;"><% mytabbed.startTab("tab1"); %>
                <table style="width: 100%;">
                  <tr>
                    <td valign="top">
                      <%{  WebLabelCompound label = new com.thera.thermfw.web.WebLabelCompound(null, null, "InterfacciaEasyCheck", "IdNumeratoreDocPrd", null); 
   label.setParent(InterfacciaEasyCheckForm); 
%><label class="<%=label.getClassType()%>" for="NumeratoreDocProd"><%label.write(out);%></label><%}%>
                    </td>
                    <td valign="top">
                      <% 
...
%>
<!--<span class="multisearchform" id="NumeratoreDocProd"></span>-->
                    </td>
                  </tr>
                  <tr>
                    <td valign="top">
                      <%{  WebLabelCompound label = new com.thera.thermfw.web.WebLabelCompound(null, null, "InterfacciaEasyCheck", "IdSerieDocPrd", null); 
   label.setParent(InterfacciaEasyCheckForm); 
%><label class="<%=label.getClassType()%>" for="SerieDocProd"><%label.write(out);%></label><%}%>
                    </td>
                    <td valign="top">
                      <% 
...
%>
<!--<span class="multisearchform" id="SerieDocProd"></span>-->
                    </td>
                  </tr>
                  <tr>
                    <td valign="top">
                      <%{  WebLabelCompound label = new com.thera.thermfw.web.WebLabelCompound(null, null, "InterfacciaEasyCheck", "IdCausaleDocProd", null); 
   label.setParent(InterfacciaEasyCheckForm); 
%><label class="<%=label.getClassType()%>" for="CausaleDocProd"><%label.write(out);%></label><%}%>
                    </td>
                    <td valign="top">
                      <% 
  WebMultiSearchForm InterfacciaEasyCheckAzienda =  
     new com.thera.thermfw.web.WebMultiSearchForm("InterfacciaEasyCheck", "Azienda", false, false, true, 1, null, null); 
  InterfacciaEasyCheckAzienda.setParent(InterfacciaEasyCheckForm); 
  InterfacciaEasyCheckAzienda.write(out); 
%>
<!--<span class="multisearchform" id="Azienda"></span>-->
                    </td>
                  </tr>
                  <tr>
                    <td valign="top">
                      <label for="DipendenteRilevazione"></label>
                    </td>
                    <td valign="top">
                      <% 
...
%>
<!--<span class="multisearchform" id="CausaleDocProd"></span>-->
                    </td>
                  </tr>
                  <tr>
                    <td valign="top">
