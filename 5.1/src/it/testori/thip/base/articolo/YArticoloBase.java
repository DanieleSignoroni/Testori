...
//import it.thera.thip.base.azienda.Azienda; 72238
 ...
 * 72238	03/12/2025	DSSOF3	 Rem setIdAzienda nel constructor per corretto funzionamento mod ridotta.
 * 72320	27/01/2026	DSSOF3	 Nuovo attributo
 */

public class YArticoloBase extends ArticoloBase {
	...
	protected boolean iFloorStockContoLavoro; //72320

	public YArticoloBase() {
		super();
		setLifetess(false);
		setLeftover(false);
		setPharma(false);
		...
		//setIdAzienda(Azienda.getAziendaCorrente()); 72238 rem
