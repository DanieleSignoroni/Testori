...
var oldgetRestrictForSearch14121 = getRestrictForSearch14121;

getRestrictForSearch14121 = function(rightFieldName){
	var retString = oldgetRestrictForSearch14121(rightFieldName);
	if(rightFieldName != null && rightFieldName === "Lotti.RLotto.DescrizioneLotto"){
		retString+= "YMostraBtnMostraTuttiLotti=Y;";
	}
	return retString;
}