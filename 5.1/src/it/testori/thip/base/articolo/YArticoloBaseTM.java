...
import it.thera.thip.base.articolo.ArticoloBaseTM;
...
public class YArticoloBaseTM extends ArticoloBaseTM {
	...
	private static final String CLASS_NAME = it.testori.thip.base.articolo.YArticoloBase.class.getName();

	public YArticoloBaseTM() throws SQLException {
		super();
	}
